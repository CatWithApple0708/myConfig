...
lt.plugins.auto_complete.skip_space = (function skip_space(s){if(cljs.core.truth_((function (){var and__3508__auto__ = lt.plugins.auto_complete.peek_STAR_.call(null,s);if(cljs.core.truth_(and__3508__auto__))
...
lt.plugins.auto_complete.string__GT_tokens = (function string__GT_tokens(str,pattern){var s = lt.plugins.auto_complete.stream.call(null,str);var res = (function (){var obj6734 = {};return obj6734;
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__6730_SHARP_){return {"completion": p1__6730_SHARP_};
}),Object.keys(res)));
});
lt.plugins.auto_complete.default_pattern = /[\w_$]/;
lt.plugins.auto_complete.get_pattern = (function get_pattern(ed){var mode = lt.objs.editor.inner_mode.call(null,ed);var or__3520__auto__ = new cljs.core.Keyword(null,"hint-pattern","hint-pattern",2825267644).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,ed));if(cljs.core.truth_(or__3520__auto__))
{return or__3520__auto__;
} else
{var or__3520__auto____$1 = (mode["hint-pattern"]);if(cljs.core.truth_(or__3520__auto____$1))
...
lt.plugins.auto_complete.non_token_change_QMARK_ = (function non_token_change_QMARK_(ed,ch){var pattern = lt.plugins.auto_complete.get_pattern.call(null,ed);var text = cljs.core.map.call(null,cljs.core.str,ch.text);var pred__6739 = cljs.core._EQ_;var expr__6740 = ch.origin;if(cljs.core.truth_(pred__6739.call(null,"+input",expr__6740)))
{return cljs.core.some.call(null,(function (p1__6735_SHARP_){return cljs.core.not.call(null,cljs.core.re_seq.call(null,pattern,p1__6735_SHARP_));
}),text);
} else
{if(cljs.core.truth_(pred__6739.call(null,"paste",expr__6740)))
{return true;
} else
{return false;
}
...
return (function (obj_id,m){var StringStream = require([cljs.core.str(ltpath),cljs.core.str("/core/node_modules/codemirror/addon/runmode/runmode.node.js")].join('')).StringStream;var stream = ((function (StringStream){
...
return (function (s){if(cljs.core.truth_((function (){var and__3508__auto__ = peek_STAR_.call(null,s);if(cljs.core.truth_(and__3508__auto__))
...
return (function (str,pattern){var s = stream.call(null,str);var pattern__$1 = cljs.core.re_pattern.call(null,pattern);var res = (function (){var obj6747 = {};return obj6747;
})();skip_space.call(null,s);
while(true){
...
return (function (p1__6742_SHARP_){return {"completion": p1__6742_SHARP_};
...
lt.plugins.auto_complete.text_BAR_completion = (function text_BAR_completion(x){var or__3520__auto__ = x.text;if(cljs.core.truth_(or__3520__auto__))
{return or__3520__auto__;
} else
{return x.completion;
}
...
lt.plugins.auto_complete.remove_long_completions = (function remove_long_completions(hints){return cljs.core.filter.call(null,(function (p1__6748_SHARP_){return (p1__6748_SHARP_.completion.length < new cljs.core.Keyword(null,"hint-limit","hint-limit",945287271).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.plugins.auto_complete.hinter)));
}),hints);
});
...
lt.plugins.auto_complete.__BEH__set_hint_limit = (function __BEH__set_hint_limit(this$,n){return lt.object.merge_BANG_.call(null,this$,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"hint-limit","hint-limit",945287271),n], null));
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.auto-complete","set-hint-limit","lt.plugins.auto-complete/set-hint-limit",1014037643),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.auto_complete.__BEH__set_hint_limit,new cljs.core.Keyword(null,"desc","desc",1016984067),"Auto-complete: Set maximum length of an autocomplete hint",new cljs.core.Keyword(null,"params","params",4313443576),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1116631654),"Number",new cljs.core.Keyword(null,"example","example",3985900764),1000], null)], null),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"object.instant","object.instant",773332388),null], null), null),new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"user","user",1017503549));
...
{var pos = lt.objs.editor.__GT_cursor.call(null,new cljs.core.Keyword(null,"ed","ed",1013907473).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$)));var token = lt.plugins.auto_complete.get_token.call(null,new cljs.core.Keyword(null,"ed","ed",1013907473).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$)),pos);if(cljs.core.truth_((function (){var or__3520__auto__ = lt.plugins.auto_complete.non_token_change_QMARK_.call(null,new cljs.core.Keyword(null,"ed","ed",1013907473).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$)),c);if(cljs.core.truth_(or__3520__auto__))
{return or__3520__auto__;
} else
...
{if(cljs.core.truth_((function (){var and__3508__auto__ = cljs.core._EQ_.call(null,1,count);if(and__3508__auto__)
...
;
lt.plugins.auto_complete.__BEH__show_hint = (function __BEH__show_hint(this$,opts){var cur = clojure.string.trim.call(null,lt.objs.editor.get_char.call(null,this$,-1));var opts__$1 = cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"select-single","select-single",4748368299),true], null),opts);if(cljs.core.truth_((function (){var and__3508__auto__ = new cljs.core.Keyword(null,"active","active",3885920888).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.plugins.auto_complete.hinter));if(cljs.core.truth_(and__3508__auto__))
...
{if(cljs.core.truth_((function (){var and__3508__auto__ = new cljs.core.Keyword(null,"active","active",3885920888).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.plugins.auto_complete.hinter));if(cljs.core.truth_(and__3508__auto__))
{return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ed","ed",1013907473).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.plugins.auto_complete.hinter)),this$);
} else
{return and__3508__auto__;
}
...
lt.plugins.auto_complete.__BEH__init = (function __BEH__init(this$){lt.util.load.js.call(null,"core/node_modules/codemirror_addons/show-hint.js",new cljs.core.Keyword(null,"sync","sync",1017449997));
