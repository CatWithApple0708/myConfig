...
{{
var G__15697 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15697;
continue;
}
} else
...
{var pred__15701 = cljs.core._EQ_;var expr__15702 = limit;if(cljs.core.truth_(pred__15701.call(null,1,expr__15702)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15701.call(null,2,expr__15702)))
...
var G__15704 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15705 = (limit__$1 - 1);
var G__15706 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15704;
limit__$1 = G__15705;
parts = G__15706;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___15708 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___15708))
{var replacement_15709 = temp__4090__auto___15708;buffer.append([cljs.core.str(replacement_15709)].join(''));
} else
{buffer.append(ch);
}
{
var G__15710 = (index + 1);
index = G__15710;
continue;
}
}
