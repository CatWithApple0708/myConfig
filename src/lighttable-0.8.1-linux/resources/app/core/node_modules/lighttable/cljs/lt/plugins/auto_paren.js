...
{var ch = lt.plugins.auto_paren.get_char.call(null,this$,-1);if(cljs.core.truth_((function (){var and__3508__auto__ = lt.plugins.auto_paren.pairs.call(null,ch);if(cljs.core.truth_(and__3508__auto__))
...
lt.plugins.auto_paren.pre_cursor_indent = (function pre_cursor_indent(ed,p__7138){var map__7140 = p__7138;var map__7140__$1 = ((cljs.core.seq_QMARK_.call(null,map__7140))?cljs.core.apply.call(null,cljs.core.hash_map,map__7140):map__7140);var ch = cljs.core.get.call(null,map__7140__$1,new cljs.core.Keyword(null,"ch","ch",1013907415));var line = cljs.core.get.call(null,map__7140__$1,new cljs.core.Keyword(null,"line","line",1017226086));var tabs = lt.objs.editor.option.call(null,ed,new cljs.core.Keyword(null,"indentWithTabs","indentWithTabs",4541079970));var unit = lt.objs.editor.option.call(null,ed,new cljs.core.Keyword(null,"indentUnit","indentUnit",1493236674));var precursor = lt.objs.editor.line.call(null,ed,line).substring(0,ch);var whitespace = cljs.core.count.call(null,cljs.core.re_find.call(null,(cljs.core.truth_(tabs)?/^\t*$/:/^ *$/),precursor));return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.quot.call(null,whitespace,unit),cljs.core.mod.call(null,whitespace,unit)], null);
});
lt.plugins.auto_paren.backspace_indent = (function backspace_indent(ed){if(cljs.core.not.call(null,(function (){var or__3520__auto__ = lt.objs.editor.selection_QMARK_.call(null,ed);if(cljs.core.truth_(or__3520__auto__))
{return or__3520__auto__;
} else
{return (lt.objs.editor.__GT_cm_ed.call(null,ed).getSelections().length > 1);
}
})()))
{var cursor = lt.objs.editor.__GT_cursor.call(null,ed);var unit = lt.objs.editor.option.call(null,ed,new cljs.core.Keyword(null,"indentUnit","indentUnit",1493236674));var vec__7143 = lt.plugins.auto_paren.pre_cursor_indent.call(null,ed,cursor);var indent = cljs.core.nth.call(null,vec__7143,0,null);var rem = cljs.core.nth.call(null,vec__7143,1,null);var cursor__$1 = (((rem > 0))?lt.plugins.auto_paren.adjust_loc.call(null,lt.objs.editor.__GT_cursor.call(null,ed),(unit - rem)):cursor);var vec__7144 = (((rem > 0))?lt.plugins.auto_paren.pre_cursor_indent.call(null,ed,cursor__$1):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [indent,rem], null));var indent__$1 = cljs.core.nth.call(null,vec__7144,0,null);var rem__$1 = cljs.core.nth.call(null,vec__7144,1,null);if(((indent__$1 > 0)) && ((rem__$1 === 0)))
